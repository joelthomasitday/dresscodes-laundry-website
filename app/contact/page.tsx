      ...
      <section className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white py-16 sm:py-20 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              <Link
                href="https://wa.me/8943437272?text=Hi! I have a question about your laundry services."
                target="_blank"
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <Link href="tel:+8943437272" className="text-emerald-600 hover:text-emerald-700 font-medium">
                          +91 89434 37272
                        </Link>
                      </div>
                    </div>
