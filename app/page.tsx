        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-2xl text-white">
            <h1 className="text-5xl sm:text-6xl font-bold mb-6">
              Premium Laundry &<span className="text-emerald-400"> Dry Cleaning</span>
            </h1>

            <p className="text-xl mb-8 text-gray-100">
              Professional laundry services with free pickup and delivery. Experience the convenience of premium care
              for your garments.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-white text-white hover:bg-white/10 bg-transparent rounded-full"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-gray-200">
              <Link href="tel:+919843437272" className="flex items-center gap-2 hover:text-white">
                <Phone className="h-5 w-5" />
                <span>Call: +91 89434 37272</span>
              </Link>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-r from-emerald-600 to-emerald-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Link href="tel:+919843437272">Call Now</Link>
            </Button>
          </div>
        </div>
      </section>
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                <Button asChild variant="outline" size="sm" className="rounded-full bg-transparent">
                  <Link href="tel:+919843437272">
                    <Phone className="h-4 w-4 mr-2" />
                    Call Us
                  </Link>
                </Button>
                <Button asChild variant="outline" size="sm" className="rounded-full bg-transparent">
                  <Link href="https://wa.me/919843437272" target="_blank" rel="noopener noreferrer">
