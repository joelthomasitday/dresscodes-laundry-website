          ...
          <div className="max-w-2xl text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-white text-white hover:bg-white/10 bg-transparent hover:text-white rounded-full"
              >
                <Link className="text-white" href="/services">View Services</Link>
              </Button>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 text-gray-200">
              <Link href="tel:+918943437272" className="flex items-center gap-2 hover:text-white">
                <Phone className="h-5 w-5" />
                <span className="font-semibold">Call: +91 89434 37272</span>
              </Link>
