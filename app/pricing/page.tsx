...
import { getWhatsAppHref, getTelHref, PHONE_DISPLAY } from "@/lib/phone"
...
*Thank you for choosing Dresscode Laundry!*`
 ...
 <section className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white py-12 sm:py-16">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <p className="mt-4 text-md sm:text-lg text-emerald-200 mb-6">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      >
        <Link
          href={getWhatsAppHref("Hi! I need help with placing a laundry order.")}
          target="_blank"
