      ...
      <section className="bg-gradient-to-r from-emerald-500 to-emerald-900 text-white py-12 sm:py-16 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-teal-100 max-w-2xl mx-auto">
            Please read these terms carefully before using our laundry and dry
            cleaning services.
          </p>
        </div>
      </section>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-700">
                These Terms of Service ("Terms") govern your use of the laundry
                and dry cleaning services provided by Dresscode Laundry Service
                ("we," "our," or "us"). By using our services, you agree to be
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    By scheduling a pickup, using our website, or engaging our
                    services in any way, you acknowledge that you have read,
                    understood, and agree to be bound by these Terms and our
                    Privacy Policy. If you do not agree to these Terms, please
                    do not use our services.
                  </p>
                  <p>
                    These Terms apply to all customers, including individuals,
                    businesses, and organizations that use our laundry and dry
                    cleaning services.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    Dresscode Laundry Service provides the following services:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      <strong>Wash & Fold:</strong> Professional washing,
                      drying, and folding of garments
                    </li>
                    <li>
                      <strong>Dry Cleaning:</strong> Specialized cleaning for
                      delicate and formal garments
                    </li>
                    <li>
                      <strong>Ironing & Pressing:</strong> Professional pressing
                      and finishing services
                    </li>
                    <li>
                      <strong>Premium Care:</strong> Specialized care for luxury
                      and delicate items
                    </li>
                    <li>
                      <strong>Pickup & Delivery:</strong> Free collection and
                      delivery within our service area
                    </li>
                  </ul>
                  <p>
                    Service availability may vary based on location, demand, and
                    operational capacity. We reserve the right to modify or
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Provide accurate contact information and service address
                    </li>
                    <li>
                      Check all pockets and remove personal items before service
                    </li>
                    <li>
                      Inform us of any stains, damage, or special care
                      requirements
                    </li>
                    <li>Separate items requiring different cleaning methods</li>
                    <li>
                      Be available during scheduled pickup and delivery times
                    </li>
                    <li>
                      Pay for services according to our pricing and payment
                      terms
                    </li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Wash & Fold: ₹140 per kilogram</li>
                    <li>Dry Cleaning: Coming soon</li>
                    <li>Ironing & Pressing: ₹20 per piece</li>
                    <li>Wash & Iron: ₹30 per piece</li>
                    <li>
                      Premium Care: Custom pricing based on item and
                      requirements
                    </li>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      We accept cash, UPI, credit/debit cards, and digital
                      wallets
                    </li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p>
                    We take utmost care in handling your garments. However, our
                    liability is limited to:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Repair or replacement of damaged items up to 10 times the
                      cleaning charge
                    </li>
                    <li>
                      Maximum liability of ₹5,000 per item unless higher value
                      is declared
                    </li>
                    <li>
                      No liability for items left unclaimed for more than 30
                      days
                    </li>
                  ...
                  <p>
                    You acknowledge that certain risks are inherent in the
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Professional cleaning according to industry standards
                    </li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Pickup appointments can be cancelled up to 2 hours before
                      scheduled time
                    </li>
                    <li>
                      Orders in process cannot be cancelled but can be modified
                      if possible
                    </li>
                    <li>
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Partial refund for unsatisfactory service after
                      re-cleaning attempt
                    </li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    Items not collected within specified timeframes will be
                    handled as follows:
                  </p>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                    ...
                    <li>
                      <strong>15 days:</strong> Second reminder with email
                      notification
                    </li>
                    <li>
                      <strong>30 days:</strong> Final notice with storage fee of
                      ₹10 per day
                    </li>
                    <li>
                      <strong>60 days:</strong> Items may be donated to charity
                      or disposed of
                    </li>
                  </ul>
                  <p>
                    We are not responsible for items left unclaimed beyond 60
                    days. Storage fees must be paid before item collection.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    ...
                    and design elements, is the property of Dresscode Laundry
                    Service and is protected by copyright and trademark laws.
                    You may not use, reproduce, or distribute our content
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    ...
                    <li>
                      Disputes will be governed by the laws of Kerala, India
                    </li>
                    <li>
                      Any legal proceedings will be subject to the jurisdiction
                      of Kottayam courts
                    </li>
                    <li>
                      We prefer mediation or arbitration before litigation
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <ul className="list-disc pl-6 space-y-2">
                    <li>
                      Natural disasters, floods, or severe weather conditions
                    </li>
              ...
              <section>
                ...
                <div className="space-y-4 text-gray-700">
                  <p>
                    ...
                    website. We will notify customers of material changes via
                    email or SMS. Your continued use of our services after
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            By using our services, you agree to these terms. Experience
            professional laundry care today!
          </p>
